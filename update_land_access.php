<?php
	...
	if ($_FILES["file2"]["error"] > 0 /*&& $_FILES["file3"]["error"] > 0*/)
	  {
	...
	else
	  {
		  ...
		  if(move_uploaded_file($_FILES['file2']['tmp_name'], $target_path2))
		  {
		  		$sql= "	update legal 
			  	  		...
			  	  		where site_id = '". $_POST['siteid_access'] ."'";
  ...
  header("Location:land_document.php?id=". $_POST['siteid_access']);
