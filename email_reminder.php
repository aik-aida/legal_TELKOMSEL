<?php
	...
	{
		$ceknull0 = " SELECT bast_tahap1, bast_tahap2, bast_tahap3, site_region 
		           	 from legal 
		           	 where site_region='".$a[0]."'";
		$ceknulls0 = mysql_query($ceknull0);
		$arr_ceknull0 = mysql_fetch_array($ceknulls0);

		if($arr_ceknull0['bast_tahap1']=='0000-00-00' || $arr_ceknull0['bast_tahap2']=='0000-00-00' || $arr_ceknull0['bast_tahap3']=='0000-00-00')
		{
			...
			$msg .= "Berikut kami sampaikan informasi Site ID dan Site Name yang harus dilakukan oleh Mitra dalam proses pencapaian tahap serah terima :<br>";
			...
			$msg .= "<tr bgcolor =YELLOW><td width=40><center>No</center></td>
				         ...
				         <td width=100><center>Regional</center></td>
			...
			$ceknull = " SELECT site_id, site_area, site_name, site_region, vendor, no_kontrak 
			           	 from legal 
				...
				if($different1<=7)
				{
					$msg.="<tr><td width=40><center>".$i."</center></td>
			               ...
			               <td width=100><center>".$arr_ceknull['site_region']."</center></td>
			                <td width=100><center>".$arr_ceknull['no_kontrak']."</center></td>
			...
			$ceknull2 = " SELECT site_id, site_area, site_name, site_region, vendor, no_kontrak 
			              from legal 
			...
			while($arr_ceknull2 = mysql_fetch_array($ceknulls2))
			{
				if($different2<=7)
				{
					$msg.="<tr><td width=40><center>".$i."</center></td>
			               ...
			               <td width=100><center>".$arr_ceknull2['no_kontrak']."</center></td>
			...
			$ceknull3 = " SELECT site_id, site_area, site_name, site_region, vendor, no_kontrak 
			              from legal 
				...
				if($different3<=7)
				{
					$msg.="<tr><td width=40><center>".$i."</center></td>
			               ...
			               <td width=100><center>".$arr_ceknull3['site_region']."</center></td>
			                <td width=100><center>".$arr_ceknull3['no_kontrak']."</center></td>
			...
			$msg.= '</table>';
			$msg.= "<br>Mohon dapat dilakukan monitoring secara intensif kepada Mitra yang bersangkutan untuk pencapaian Pekerjaan.";
